...
function minhaFuncao() {
  ...
  // 3 - escopo da função
  console.log("================= 3 - Escopo da função =================");
  let y = 10;
  ...
  console.log("================= 6 - Mais sobre arrow functions =================");
  ...
  console.log("================= 10 - Mais sobre closure =================");
